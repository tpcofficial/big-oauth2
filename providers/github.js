...
class GitHubHandler {
    constructor(configobj,extraOptions) {
        ...
        this.config.redirect_uri = configobj.redirect_uri; //We recommend setting this to something like https://example.org/api/oauth2/GitHub
        this.config.platform_name = 'GitHub';
        ...
        this.config.auth_base_url = configobj.auth_base_url ? configobj.auth_base_url : "https://github.com/login/oauth/authorize";
        this.config.token_url = configobj.token_url ? configobj.token_url : "https://github.com/login/oauth/access_token";
            ...
            if (returnedData.code) {
                ...
                this.libs.OAuth2Lib.stopFlow(returnedData)
                    .then(tokenData => {
                        ...
                        this.libs.fetch(`https://api.github.com/user`,{method:'GET',headers: {'Authorization': `token ${tokenData.access_token}`}})
